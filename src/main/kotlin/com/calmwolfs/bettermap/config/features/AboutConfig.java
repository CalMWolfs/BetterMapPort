...
import com.calmwolfs.bettermap.utils.WebUtils;
...
public class AboutConfig {
    ...
    public static class Licenses {
        ...
        @ConfigOption(name = "BetterMap (ctjs)", desc = "BetterMap has no license")
        @ConfigEditorButton(buttonText = "Source")
        public Runnable bettermap = () -> WebUtils.openBrowser("https://github.com/BetterMap/BetterMap");

        @ConfigOption(name = "SoopyAddons", desc = "SoopyAddons is available under the LGPL 3.0 License or later version")
        @ConfigEditorButton(buttonText = "Source")
        public Runnable soopy = () -> WebUtils.openBrowser("https://github.com/Soopyboo32/SoopyV2");
